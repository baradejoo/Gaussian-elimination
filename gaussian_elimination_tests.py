...
def write_to_file(memory_usage_, speed_, logic='FAILED'):
    myFile = 'Results.csv'
    ...
    with open(myFile, "a", newline='\n') as f:
        ...
        writer.writerow({header[0]: 1, header[1]: memory_usage_, header[2]: speed_, header[3]: logic})
...
class GECase(unittest.TestCase):
    def test_1(self):
        ...
        write_to_file(memory_usage_=memory_usage, speed_=speed, logic='PASSED')
    ...
    def test_3(self):
        ...
        write_to_file(memory_usage_=memory_usage, speed_=speed)
